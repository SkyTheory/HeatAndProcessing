...
public class ItemAmuletGW extends Item implements IJewelCharm, IBauble {
	...
	public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag advanced) {
		tooltip.add(TextFormatting.AQUA.toString() + I18n.format(ConstantsHaP.TIP_AMULET_GW_TITLE));
		if (ClimateCore.proxy.isShiftKeyDown()) {
			tooltip.add(TextFormatting.YELLOW.toString() + TextFormatting.BOLD
					.toString() + "=== Tips ===");
			tooltip.add(TextFormatting.YELLOW.toString() + I18n.format(ConstantsHaP.TIP_AMULET_GW_CONTENTS));
		} else {
