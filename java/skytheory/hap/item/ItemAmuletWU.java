...
public class ItemAmuletWU extends Item implements IJewelCharm, IBauble {
	...
	public void constantEffect(EntityLivingBase owner, ItemStack charm) {
		owner.addPotionEffect(new PotionEffect(DCInit.prevFreeze, 205, 0));
	}
	...
	public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag advanced) {
		tooltip.add(TextFormatting.AQUA.toString() + I18n.format(ConstantsHaP.TIP_AMULET_WU_TITLE));
		if (ClimateCore.proxy.isShiftKeyDown()) {
			tooltip.add(TextFormatting.YELLOW.toString() + TextFormatting.BOLD
					.toString() + "=== Tips ===");
			tooltip.add(TextFormatting.YELLOW.toString() + I18n.format(ConstantsHaP.TIP_AMULET_WU_CONTENTS));
		} else {
