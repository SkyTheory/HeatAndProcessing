...
public class ItemAmuletUB extends Item implements IJewelCharm, IBauble {
	...
	public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag advanced) {
		tooltip.add(TextFormatting.AQUA.toString() + I18n.format(ConstantsHaP.TIP_AMULET_UB_TITLE));
		if (ClimateCore.proxy.isShiftKeyDown()) {
			tooltip.add(TextFormatting.YELLOW.toString() + TextFormatting.BOLD
					.toString() + "=== Tips ===");
			tooltip.add(TextFormatting.YELLOW.toString() + I18n.format(ConstantsHaP.TIP_AMULET_UB_CONTENTS));
		} else {
