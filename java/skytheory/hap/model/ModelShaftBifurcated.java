...
public class ModelShaftBifurcated extends ModelBase implements ITileModel<TileShaftBifurcated> {

	public static ModelShaftBifurcated INSTANCE = new ModelShaftBifurcated();
	...
	@Override
	public void render(TileShaftBifurcated tile, float partialtick) {
