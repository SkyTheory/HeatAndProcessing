...
public class ModelShaftXShaped extends ModelBase implements ITileModel<TileShaftXShaped> {

	public static ModelShaftXShaped INSTANCE = new ModelShaftXShaped();

	private final ModelRenderer body;
	private final ModelRenderer input;
	private final ModelRenderer output1;
	private final ModelRenderer output2;
	private final ModelRenderer output3;
	...
	private final ModelRenderer output3_shaft;
	private final ModelRenderer gearbox;

	public ModelShaftXShaped() {
		textureWidth = 64;
		textureHeight = 64;
		...
		output2.cubeList.add(new ModelBox(output2, 14, 0, -3.0f, 7.0f, -3.0f, 6, 1, 6, 0.0f, false));
		output2.cubeList.add(new ModelBox(output2, 14, 7, -3.0f, 6.25f, -3.0f, 6, 1, 6, -0.75f, false));

		output3 = new ModelRenderer(this);
		output3.setRotationPoint(0.0f, 0.0f, 0.0f);
		body.addChild(output3);
		output3.cubeList.add(new ModelBox(output3, 0, 7, -3.0f, -3.0f, -8.0f, 6, 6, 1, 0.0f, false));
		output3.cubeList.add(new ModelBox(output3, 0, 14, -3.0f, -3.0f, -7.25f, 6, 6, 1, -0.75f, false));
		...
		output2_shaft.cubeList.add(new ModelBox(output2_shaft, 19, 54, -1.5f, 2.5f, -1.5f, 3, 4, 3, 0.0f, false));

		output3_shaft = new ModelRenderer(this);
		output3_shaft.setRotationPoint(0.0f, 0.0f, 0.0f);
		body.addChild(output3_shaft);
		output3_shaft.cubeList.add(new ModelBox(output3_shaft, 0, 41, -1.5f, -1.5f, -6.5f, 3, 3, 4, 0.0f, false));
	...
	@Override
	public void render(TileShaftXShaped tile, float partialtick) {
		...
		output2_shaft.rotateAngleY = -FloatUtils.toRadian(angle2 + delta2 * partialtick);
		output3_shaft.rotateAngleZ = FloatUtils.toRadian(angle2 + delta2 * partialtick);
