...
public class ModelShaftTShaped extends ModelBase implements ITileModel<TileShaftTShaped> {

	public static ModelShaftTShaped INSTANCE = new ModelShaftTShaped();
	...
	public ModelShaftTShaped() {
		...
		output1.cubeList.add(new ModelBox(output1, 0, 7, -3.0f, -3.0f, -8.0f, 6, 6, 1, 0.0f, false));
		output1.cubeList.add(new ModelBox(output1, 0, 14, -3.0f, -3.0f, -7.25f, 6, 6, 1, -0.75f, false));

		output2 = new ModelRenderer(this);
		output2.setRotationPoint(0.0f, 0.0f, 0.0f);
		body.addChild(output2);
		output2.cubeList.add(new ModelBox(output2, 14, 0, -3.0f, -8.0f, -3.0f, 6, 1, 6, 0.0f, false));
		output2.cubeList.add(new ModelBox(output2, 14, 7, -3.0f, -7.25f, -3.0f, 6, 1, 6, -0.75f, false));
		...
		output1_shaft.cubeList.add(new ModelBox(output1_shaft, 0, 41, -1.5f, -1.5f, -6.5f, 3, 3, 4, 0.0f, false));

		output2_shaft = new ModelRenderer(this);
		output2_shaft.setRotationPoint(0.0f, 0.0f, 0.0f);
		body.addChild(output2_shaft);
		output2_shaft.cubeList.add(new ModelBox(output2_shaft, 0, 54, -1.5f, -6.5f, -1.5f, 3, 4, 3, 0.0f, false));
	...
	@Override
	public void render(TileShaftTShaped tile, float partialtick) {
		...
		output1_shaft.rotateAngleZ = FloatUtils.toRadian(angle2 + delta2 * partialtick);
