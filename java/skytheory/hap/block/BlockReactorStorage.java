...
public class BlockReactorStorage extends BlockContainer implements IWrenchBlock, IWailaTipBlock{

	public static final IProperty<EnumFacing> FACING = BlockHorizontal.FACING;

	public BlockReactorStorage() {
		super(Material.ROCK);
	...
	public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag advanced) {
		if (ClimateCore.proxy.isShiftKeyDown()) {
			...
			tooltip.add(I18n.format(ConstantsHaP.TIP_REACTOR_STORAGE));
		} else {
